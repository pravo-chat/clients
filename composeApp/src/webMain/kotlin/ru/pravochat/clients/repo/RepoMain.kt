...
class StaticRepoMain(@Suppress("unused") private val scope: CoroutineScope) : RepoMain {
    private val introductionState = MutableStateFlow(INTRO_TEXT)

    override fun introduction(): Flow<String> = introductionState.asStateFlow()
